...
import { type ThemeColor, type ThemeMode, THEME_STORAGE_KEY, MODE_STORAGE_KEY } from "@/lib/theme-config"
...
export function ThemeProvider({ children, defaultColor = "sage", defaultMode = "system" }: ThemeProviderProps) {
