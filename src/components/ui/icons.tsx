...
export const Icons = {
  ...
  twitter: (props: IconProps) => (
    <svg height="23" viewBox="0 0 1200 1227" width="23" xmlns="http://www.w3.org/2000/svg" {...withTitle("Twitter logo", props)}>
      <title>Twitter logo</title>
      <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" />
    </svg>
  ),
  gitHub: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...withTitle("Tailwind CSS logo", props)}>
  ...
  npm: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...withTitle("npm logo", props)}>
  ...
  yarn: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...withTitle("Yarn logo", props)}>
  ...
  pnpm: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...withTitle("pnpm logo", props)}>
      <title>pnpm logo</title>
      <path
        d="M3 5h6v6H3V5zm6 0h6v6H9V5zm6 0h6v6h-6V5zM3 13h6v6H3v-6zm6 0h6v6H9v-6zm6 0h6v6h-6v-6z"
        fill="currentColor"
      />
    </svg>
  ),
  react: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...withTitle("React logo", props)}>
      <title>React logo</title>
      <circle cx="12" cy="12" r="2" fill="currentColor" />
    </svg>
  ),
  tailwind: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...withTitle("Tailwind logo", props)}>
      <title>Tailwind logo</title>
      <path
        d="M3 10c1.5-3 4.5-4.5 7.5-3 1.5.75 2.25 2.25 3.75 3 1.5.75 3.75.75 6.75-2.25-1.5 3-4.5 4.5-7.5 3-1.5-.75-2.25-2.25-3.75-3-1.5-.75-3.75-.75-6.75 2.25z"
        fill="currentColor"
      />
    </svg>
  ),
  v0: (props: IconProps) => (
    <svg viewBox="0 0 40 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...withTitle("V0 logo", props)}>
      <title>V0 logo</title>
      <path
  ...
  apple: (props: IconProps) => (
    <svg viewBox="0 0 24 24" {...decorative(props)}>
      <path
  ...
  sun: (props: IconProps) => <Sun title="Sun icon" aria-label="Sun icon" {...props} />,
  moon: (props: IconProps) => <Moon title="Moon icon" aria-label="Moon icon" {...props} />,
  monitor: (props: IconProps) => <Monitor title="Monitor icon" aria-label="Monitor icon" {...props} />,
  palette: (props: IconProps) => <Palette title="Palette icon" aria-label="Palette icon" {...props} />,
  check: (props: IconProps) => <Check title="Check icon" aria-label="Check icon" {...props} />,
  menu: (props: IconProps) => <Menu title="Menu icon" aria-label="Menu icon" {...props} />,
  shieldCheck: (props: IconProps) => (
    <ShieldCheck title="Shield check icon" aria-label="Shield check icon" {...props} />
  ),
  fileText: (props: IconProps) => <FileText title="File text icon" aria-label="File text icon" {...props} />,
  badgeCheck: (props: IconProps) => (
    <BadgeCheck title="Badge check icon" aria-label="Badge check icon" {...props} />
  ),
  music: (props: IconProps) => <Music2 title="Music icon" aria-label="Music icon" {...props} />,
  mic: (props: IconProps) => <Mic2 title="Microphone icon" aria-label="Microphone icon" {...props} />,
  headphones: (props: IconProps) => (
    <Headphones title="Headphones icon" aria-label="Headphones icon" {...props} />
  ),
  mail: (props: IconProps) => <Mail title="Mail icon" aria-label="Mail icon" {...props} />,
  chevronDown: (props: IconProps) => (
    <ChevronDown title="Chevron down" aria-label="Chevron down" {...props} />
  ),
  chevronUp: (props: IconProps) => <ChevronUp title="Chevron up" aria-label="Chevron up" {...props} />,
  chevronRight: (props: IconProps) => (
    <ChevronRight title="Chevron right" aria-label="Chevron right" {...props} />
  ),
  circle: (props: IconProps) => <Circle title="Circle icon" aria-label="Circle icon" {...props} />,
  escrow: (props: IconProps) => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
