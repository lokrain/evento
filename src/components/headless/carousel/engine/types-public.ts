...
// Allow data-* on binding props
export type DataAttributes = Record<string, string | number | boolean | undefined>;
...
export interface CarouselBindings {
  ...
  getSlideProps<P extends React.ComponentPropsWithRef<"div"> & DataAttributes>(renderIndex: number, user?: P): P;
  ...
  pagination: {
    ...
    getDotProps<P extends React.ComponentPropsWithRef<"button"> & DataAttributes>(index: number, user?: P): P;
  };
  autoplayToggle: {
