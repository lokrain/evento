...
const sansFontData = readFile(path.join(process.cwd(), "src/assets/fonts/PlovdivSans.otf"));
    ...
    >
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(circle at 50% 120%, rgba(147, 51, 234, 0.12), transparent 45%)",
        }}
      />
      <div
        style={{
      ...
      <div
        style={{ position: "relative", display: "flex", justifyContent: "space-between", gap: 40 }}
      >
        <div style={{ flex: 1.15, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            <span style={{ color: "#a5b4fc", fontSize: 18, fontWeight: 700, letterSpacing: 0.3 }}>
              {t("pill")}
            </span>
            <span style={{ color: "#cbd5f5", fontSize: 16, letterSpacing: 0.4 }}>
              {t("eyebrow")}
            </span>
          </div>

          <div
            style={{ fontFamily: "Plovdiv Display", fontSize: 96, lineHeight: 1, color: "#f8fafc" }}
          >
            {t("title")}
          </div>

          <div style={{ fontSize: 32, color: "#c7d2fe", fontWeight: 700, letterSpacing: 0.5 }}>
            {t("tagline")}
          </div>
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2,minmax(0,1fr))", gap: 14 }}>
            {stats.map((stat) => (
              ...
              >
                <div style={{ color: "#94a3b8", fontSize: 14, letterSpacing: 0.4 }}>
                  {stat.label}
                </div>
                <div style={{ color: "#e2e8f0", fontSize: 26, fontWeight: 700, marginTop: 6 }}>
                  {stat.value}
                </div>
              </div>
            ))}
      ...
      >
        ...
        <span style={{ color: "#94a3b8", fontSize: 15, letterSpacing: 0.5 }}>
          {t("footerLine")}
        </span>
      </div>
    </div>,
